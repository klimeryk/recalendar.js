...
function Itinerary(props) {
  ...
  function renderRow({ id, value, type, prefix }) {
    return (
  ...
  return (
    <>
      ...
      <Stack direction="horizontal" className="mt-3" gap={3}>
        <ButtonGroup>
          <Button variant="outline-secondary" onClick={onAdd} data-type={ITINERARY_ITEM} data-field={field}>
            {t('configuration.itinerary.button.item')}
          </Button>
          <Button variant="outline-secondary" onClick={onAdd} data-type={ITINERARY_LINES} data-field={field}>
            {t('configuration.itinerary.button.lines')}
          </Button>
          <Button variant="outline-secondary" onClick={onAdd} data-type={ITINERARY_NEW_PAGE} data-field={field}>
            {t('configuration.itinerary.button.page')}
          </Button>
        </ButtonGroup>
      </Stack>
      {onCopy && (
        <Button variant="outline-danger" className="mt-3" onClick={onCopy} data-field={field}>
