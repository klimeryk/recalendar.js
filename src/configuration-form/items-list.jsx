...
function ItemsList(props) {
  ...
  function renderItem({ id, value }) {
    ...
    return <SortableItem key={id} id={id} value={value} onChange={onChange} onRemove={onRemove} field={field} />;
  }
    ...
    <Accordion.Item eventKey={field}>
      ...
      <Accordion.Body>
        ...
        <Stack direction="horizontal" className="mt-3">
          <Button variant="outline-secondary" onClick={onAdd} data-field={field}>
