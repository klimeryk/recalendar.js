...
import { CONFIGURATOR_PATH, FAQ_PATH, FEATURES_PATH, HOME_PATH } from '~/lib/paths';
        ...
        <Container fluid>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto" variant="pills">
              ...
              <Nav.Item>
                <Nav.Link href={FEATURES_PATH}>{t('navigation.features')}</Nav.Link>
              </Nav.Item>
              <Nav.Item>
            ...
            <Stack direction="horizontal">
              <Form.Label column className="me-3 mt-0" htmlFor="languagePicker">
                {t('language.label')}
              </Form.Label>
              <Form.Select
              ...
              >
                ...
                <optgroup label={t('language.partial')}>
                  {getPartiallySupportedLocales().map(this.renderPartialLanguageOption)}
                </optgroup>
              </Form.Select>
            </Stack>
          </Navbar.Collapse>
